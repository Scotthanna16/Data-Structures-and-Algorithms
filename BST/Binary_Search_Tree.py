...
class Binary_Search_Tree:
  ...
  def __rotate(self,node,child):
    ...
    if node.right!=None and child.value == node.right.value:
      ...
      if temp_node.left.right==None:
        if temp_node.left.left==None:
          temp_node.left.height =1
          temp_node.height=2
        else:
          temp_node.height=temp_node.left.left.height+2
        ...
        if temp_node.right!=None:
          if temp_node.left.height>temp_node.right.height:
            ...
            if temp_node.height<temp_node.right.height:
  ...
  def to_list(self,):
    ...
    avl_list=self.__recursive_list(self.__root)
    return avl_list

  def __recursive_list(self,node):
    temp_list=[]
    if node.left != None or node.right != None:
      left_list=[]
      right_list=[]
      if node.left!= None:
        left_list=self.__recursive_list(node.left)
      temp_list+=[node.value]
      if node.right!=None:
        right_list=self.__recursive_list(node.right)
      if left_list == False and right_list ==False:
        return temp_list
      elif left_list==False:
        temp_list=[node.value]+right_list
        return temp_list
      elif right_list==False:
        temp_list=left_list+[node.value]
        return temp_list
      else:
        temp_list=left_list+[node.value]+right_list
        return temp_list
